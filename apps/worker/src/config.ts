...
export const config = {
  ...
  /**
   * Eyni worker prosesində paralel iş sayı. Default 1 — hər iş bir Chromium + ffmpeg tutur.
   * Çoxaldıqda RAM/CPU və Meet limitləri nəzərə alın; paralel işçilər üçün bir neçə worker konteyner işə salmaq daha təhlükəsizdir.
   */
